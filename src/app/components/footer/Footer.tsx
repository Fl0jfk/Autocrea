        ...
        <footer className="bg-black text-white flex w-full flex-col">
            <div className="h-[40vh] flex justify-center w-full gap-16 p-12 pt-24 sm:flex-col sm:h-full">
                ...
                <div className="flex flex-col gap-6 w-[20%] sm:w-full">
                    ...
                    <ul className="flex flex-col gap-2">
                        <li><Link href={"/"} aria-label="Lien vers la page société" className="text-sm">Société</Link></li>
                        <li><Link href={"/"} aria-label="Lien vers la page sf" className="text-sm">Savoir-faire</Link></li>
                        <li><Link href={"/"} aria-label="Lien vers la page r" className="text-sm">Références</Link></li>
                        <li><Link href={"/"} aria-label="Lien vers la page presse" className="text-sm">Presse</Link></li>
                        <li><Link href={"/"} aria-label="Lien vers la page photo" className="text-sm">Phototèque</Link></li>
                        <li><Link href={"/"} aria-label="Lien vers la page contact" className="text-sm">Contact</Link></li>
                    </ul>
                </div>
                <div className="flex flex-col gap-6 w-[20%] sm:w-full">
                    <h3>Nos supports de communication</h3>
                    <ul className="flex flex-col gap-2">
                        <li><Link href={"/"} aria-label="Lien vers la page stp" className="text-sm">Le set de table publicitaire</Link></li>
                        <li><Link href={"/"} aria-label="Lien vers la page ebp" className="text-sm">L&apos;étui à baguette publicitaire</Link></li>
                        <li><Link href={"/"} aria-label="Lien vers la page spp" className="text-sm">Le sachet pharmacie publicitaire</Link></li>
                        <li><Link href={"/"} aria-label="Lien vers la page sppub" className="text-sm">Le sachet primeur publicitaire</Link></li>
                    </ul>
                </div>
                <div className="flex flex-col gap-6 w-[20%] sm:w-full">
                    <h3>Réseaux sociaux</h3>
                    <ul className="flex gap-2">
                        <li><Link href={"/"} aria-label="Lien vers la page in">
                        ...
                        <li><Link href={"/"} aria-label="Lien vers la page li">
                        ...
                        <li><Link href={"/"} aria-label="Lien vers la page fa">
                            <svg width="22px" height="22px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li><Link href={"/"} aria-label="Lien vers la page tw">
            ...
            <div className="w-full flex flex-col sm">
                ...
                <div className="flex self-end gap-1 items-center justify-center text-sm p-4 sm:pb-4 sm:p-1 sm:pt-4">
                    ...
                    <span>-</span>
                    <Link href={"/"} aria-label="Lien vers la page mentions">Mentions légales</Link>
                </div>
            </div>
        </footer>
    )
