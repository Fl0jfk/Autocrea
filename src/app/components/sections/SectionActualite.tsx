...
export default function SectionActualite (){
    return (
        <section className="flex flex-col p-16 items-center justify-center gap-12">
            ...
            <div className="flex items-center justify-center gap-8 w-[90%] mx-auto">
                <Link href={"/"} className="flex flex-col gap-12 w-1/3 items-center hover:scale-105 duration-300">
