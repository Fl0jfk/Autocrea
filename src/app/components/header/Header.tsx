   ...
   useMotionValueEvent(scrollY, "change", (latest) => {
    ...
    return (
        <motion.header 
            ...
            className={`flex p-4 justify-between w-full fixed z-[12] md:mb-[100px] h-[100px] ${opacityMenu} max-w-[1440px] self-center shadow-xl border-b bg-white`}>
                <div className='w-2/12 flex items-center pt-4'>
                    <Image src={LogoAutoCrea} alt='Logo Auto Crea' width={250} height={100}/>
                </div>
