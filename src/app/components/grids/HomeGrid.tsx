...
export default function HomeGrid (){
    return (
        <section className="grid grid-cols-2 sm:grid-cols-1 w-3/4 mx-auto gap-12 p-8">
            <Link href={"/"} aria-label="test" className="flex flex-col items-center justify-center gap-4">
            ...
            <Link href={"/"} aria-label="test2" className="flex flex-col items-center justify-center gap-4">
            ...
            <Link href={"/"} aria-label="test3" className="flex flex-col items-center justify-center gap-4">
            ...
            <Link href={"/"} aria-label="test4" className="flex flex-col items-center justify-center gap-4">
